...
<li class="nav-item dropdown">
  ...
  <ul class="dropdown-menu" aria-labelledby="dropdown2">
    <li><a class="dropdown-item" href="estrutura4.php">For</a></li>
<li><a class="dropdown-item" href="estrutura5.php">While</a></li>
<li><a class="dropdown-item" href="estrutura6.php">Do While</a></li>
  </ul>
</li>
      </ul>
    </div>
